...
if __name__ == '__main__':
    ...
    images_dir = '/media/4TB/datasets/playing_cards/scenes/test'
    classes_fn = '/media/4TB/datasets/playing_cards/scenes/cards.names'
    list_fn = '/media/4TB/datasets/playing_cards/scenes/test.txt'
